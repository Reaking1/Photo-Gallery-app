...
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var page, limit, skip, photos, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                limit = 10;
                skip = (page - 1) * limit;
                return [4 /*yield*/, Photo_1.PhotoModel.find().skip(skip).limit(limit)];
            case 1:
                photos = _a.sent();
                res.json(photos);
                return [3 /*break*/, 3];
...
router.get('/search', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var query, photos, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                query = req.query.q;
                return [4 /*yield*/, Photo_1.PhotoModel.find({ $text: { $search: query } })];
            case 1:
                photos = _a.sent();
                res.json(photos);
                return [3 /*break*/, 3];
